    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            table_create_query = '''CREATE TABLE IF NOT EXISTS Student_Data 
                    (firstname varchar(30), lastname varchar(30), title varchar(20), age INT, nationality varchar(20), 
                    registration_status varchar(20), num_courses INT, num_semesters INT)
            '''
